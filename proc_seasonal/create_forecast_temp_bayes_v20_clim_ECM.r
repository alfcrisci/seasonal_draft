...
outdir="/home/salute/data/output/clima/v20_clim_ECM/"
...
tg_full_bayes=readRDS(paste0(dir_eobs_statbayes,"/","fullstat_bayes_wtclim_tg_clim.rds")) 
tx_full_bayes=readRDS(paste0(dir_eobs_statbayes,"/","fullstat_bayes_wtclim_tx_clim.rds")) 
tn_full_bayes=readRDS(paste0(dir_eobs_statbayes,"/","fullstat_bayes_wtclim_tn_clim.rds"))
...
san9_weights=read.table("/home/salute/seasonal/PESI_ECM-san9.csv",header=T) 

saveRDS(san9_weights,paste0("/home/salute/seasonal/archive/san9_weights_ECM_",Sys.Date(),"_",period_wt,".rds"))
...
message("Forecast Temperatures 8110...fatto!")
#############################################################################################
