...
/usr/bin/Rscript create_forecast_temp_bayes_v20_clim_ECM.r
/usr/bin/Rscript create_forecast_rain_bayes_v20_clim_ECM.r
/usr/bin/Rscript create_forecast_temp_bayes_v20_9818_ECM.r
/usr/bin/Rscript create_forecast_rain_bayes_v20_9818_ECM.r

echo "Procedura su pesi ECMWF per il calcolo degli ensemble che produce netcdf"
