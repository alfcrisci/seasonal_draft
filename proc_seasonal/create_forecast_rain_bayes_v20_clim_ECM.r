...
stat_bayes_wtclim_rr=readRDS(paste0(dir_eobs_statbayes,"/","fullstat_bayes_wtclim_rr_clim.rds")) 

################################################################l#########################
# read pesi already calculated and storing in R format

pct9_weights=read.table("/home/salute/seasonal/PESI_ECM-pct9.csv", header=T) 

saveRDS(pct9_weights,paste0("/home/salute/seasonal/archive/pct9_weights_ECM_",Sys.Date(),"_",period_wt,".rds"))
...
message("Forecast Rainfall 8110...fatto!")
